  ...
  >
    ...
    <Transition name="custom-keyboard">
      <div
        ...
        class="fixed inset-x-0 baseFlex select-none touch-manipulation bottom-0 h-[calc(env(safe-area-inset-bottom)+240px)] z-50 border-t border-border bg-background/95 px-2 pb-[calc(env(safe-area-inset-bottom)+0.5rem)] pt-2 shadow-2xl backdrop-blur"
      >
